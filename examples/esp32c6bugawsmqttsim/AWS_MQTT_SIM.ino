...
const char *clientID = "Esp32-Bug-Sim-0";
...
const char MQTT_Server_URL[] = "a2nwf74zxg60e6.iot.eu-central-1.amazonaws.com"; // You must strip out the "-ats" from the endpoint original URL
...
void setup()
{
    ...
    pinMode(BOARD_MODEM_PER_PIN, OUTPUT);
    digitalWrite(BOARD_MODEM_PER_PIN,HIGH);
    ...
    /***********************************
     * step 4 : Set the network mode to CAT
     ***********************************/

    Serial.println("............................................................................Step 4");
    Serial.println("start to set the network mode to CAT ");

    modem.setNetworkMode(2); // use automatic

    modem.setPreferredMode(1); //1-CAT,2-NB-IOT,3-Both
    ...
    {
        Serial.println("SSL get error!");
    }
    else
    {
        Serial.println("SSL certs:");
        Serial.println(response);
    }
    ...
    while (true)
    {
        ...
        if (response.indexOf("ERROR") >= 0) // Check if the response contains "ERROR"
        {
            Serial.println("Connect failed, response:");
...
//    }
    ...
    // Publish topic, below is an example, you need to create your own topic
    String pub_topic = "esp32/pub";

    // Publish payload (JSON format), below is an example, you need to create your own payload
    String pub_payload = "{\"message\":\"Hello from Esp32-Bug-Sim\"}";
    ...
    if (modem.waitResponse(">") == 1)
    {
        modem.stream.write(pub_payload.c_str(), pub_payload.length()+1);
        Serial.println("");
        Serial.println(".......................................");
        Serial.println("Publishing below topic and payload now: ");
        Serial.println(pub_topic.c_str());
